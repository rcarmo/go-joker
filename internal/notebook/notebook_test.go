...
func TestNotebookPageRenders(t *testing.T) {
	...
	if !strings.Contains(w.String(), "mermaid-rounded-node") || !strings.Contains(w.String(), "mermaid-orthogonal-edge") || !strings.Contains(w.String(), "/assets/codemirror/lib/codemirror.js") || !strings.Contains(w.String(), "jokerHint") || !strings.Contains(w.String(), "autoCloseBrackets") || !strings.Contains(w.String(), "/assets/echarts.min.js") || !strings.Contains(w.String(), "/assets/mermaid.min.js") || !strings.Contains(w.String(), "mermaid.initialize") || !strings.Contains(w.String(), "echarts.init") || !strings.Contains(w.String(), "shouldUseMermaidOrthogonalFallback") || !strings.Contains(w.String(), "roundedOrthogonalPath") || !strings.Contains(w.String(), "renderMermaidFlow") || !strings.Contains(w.String(), "table-filter") || !strings.Contains(w.String(), "filterRows") || !strings.Contains(w.String(), "Show all") || !strings.Contains(w.String(), "showAll") || !strings.Contains(w.String(), "Showing ") || !strings.Contains(w.String(), "truncated") || !strings.Contains(w.String(), "sortTable") || !strings.Contains(w.String(), "data-col") || !strings.Contains(w.String(), "updateRaw") || !strings.Contains(w.String(), "renderTables") || !strings.Contains(w.String(), "table-output") || !strings.Contains(w.String(), "markdown-preview") || !strings.Contains(w.String(), "function md") || !strings.Contains(w.String(), "showSnapshots") || !strings.Contains(w.String(), "restoreSnapshot") || !strings.Contains(w.String(), "snapshot-list") || !strings.Contains(w.String(), "beforeunload") || !strings.Contains(w.String(), "Unsaved changes") || !strings.Contains(w.String(), "keydown") || !strings.Contains(w.String(), "activeCell") || !strings.Contains(w.String(), "activeCellElement") || !strings.Contains(w.String(), "Alt-Enter") || !strings.Contains(w.String(), "--font-ui:ui-sans-serif") || !strings.Contains(w.String(), "--font-mono:ui-monospace") || !strings.Contains(w.String(), "font-family:var(--font-ui)") || !strings.Contains(w.String(), "font-family:var(--font-mono)") || !strings.Contains(w.String(), "data-theme") || !strings.Contains(w.String(), "setTheme") || !strings.Contains(w.String(), "notebook-title") || !strings.Contains(w.String(), "notebook-status") || !strings.Contains(w.String(), "notebook-log") || !strings.Contains(w.String(), "apiText") || !strings.Contains(w.String(), "cell-header") || !strings.Contains(w.String(), "cell-bracket") || !strings.Contains(w.String(), "cell-insert") || !strings.Contains(w.String(), "state-pill") || !strings.Contains(w.String(), "Out[") || !strings.Contains(w.String(), "Evaluate all") || !strings.Contains(w.String(), "Export Markdown") || !strings.Contains(w.String(), "Load raw EDN") || !strings.Contains(w.String(), "Clear all outputs") || !strings.Contains(w.String(), "Clear outputs") || !strings.Contains(w.String(), "Evaluate downstream") || !strings.Contains(w.String(), "Check deps") || !strings.Contains(w.String(), "Show dependency graph") || !strings.Contains(w.String(), "Add code") || !strings.Contains(w.String(), "Add code below") || !strings.Contains(w.String(), "cell-name") || !strings.Contains(w.String(), "cell-deps") || !strings.Contains(w.String(), "deleteCell") || !strings.Contains(w.String(), "moveCell") || !strings.Contains(w.String(), "highlight") || !strings.Contains(w.String(), "renderCharts") || !strings.Contains(w.String(), "renderGraphs") || !strings.Contains(w.String(), "save-sources") {
...
func TestCellMutationHelpers(t *testing.T) {
	...
	if !insertCellAfter(&nb, "cell-1", Cell{ID: "cell-2"}) || len(nb.Cells) != 3 || nb.Cells[1].ID != "cell-2" {
		t.Fatalf("insert result = %#v", nb.Cells)
	}
	if !deleteCell(&nb, "cell-1") || len(nb.Cells) != 2 || nb.Cells[0].ID != "cell-2" || nb.Cells[1].ID != "cell-3" {
