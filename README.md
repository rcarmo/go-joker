...
Based on the original Joker v1.7.2 codebase plus selected upstream feature ports. This fork is v42.8.13.
Release notes: [`docs/RELEASE_NOTES_v42.8.13.md`](docs/RELEASE_NOTES_v42.8.13.md).
