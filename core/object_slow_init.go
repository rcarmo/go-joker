...
func init() {
	TYPE = coretypes.Types{
		...
		Boolean:        typeBuilder().RegisterValue("Boolean", (*Boolean)(nil), "Wraps the Go 'bool' type"),
		Time:           typeBuilder().RegisterValue("Time", (*Time)(nil), "Wraps the Go 'time.Time' type"),
		Buffer:         typeBuilder().RegisterReference("Buffer", (*Buffer)(nil), ""),
		Char:           typeBuilder().RegisterValue("Char", (*Char)(nil), "Wraps the Go 'rune' type"),
		...
		Double:         typeBuilder().RegisterValue("Double", (*Double)(nil), "Wraps the Go 'float64' type"),
		...
		Int: typeBuilder().RegisterValue("Int", (*Int)(nil),
		...
		Regex:         typeBuilder().RegisterReference("Regex", (*Regex)(nil), "Wraps the Go 'regexp.Regexp' type"),
