...
// comment/regex scanning, identifier rune checks/validation, identifier token scanning/validation, initial token classification, number token classification, string/unicode escape scanning/parsing, line rune readers,
