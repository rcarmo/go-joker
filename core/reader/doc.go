...
// comment/regex/string scanning, named character classification, delimiter/comment/terminating macro classification, delimiter token scanning, expected-token consumption, string escape classification, identifier rune checks/validation, identifier token scanning/validation, initial token classification, number/unicode token classification/scanning, string/unicode escape scanning/parsing, line rune readers,
