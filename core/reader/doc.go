...
// comment/regex scanning, delimiter token scanning, expected-token consumption, string escape classification, identifier rune checks/validation, identifier token scanning/validation, initial token classification, number/unicode token classification/scanning, string/unicode escape scanning/parsing, line rune readers,
