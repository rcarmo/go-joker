...
// identifier rune checks/validation, identifier token validation, initial token classification, number token classification, string/unicode escape parsing, line rune readers,
