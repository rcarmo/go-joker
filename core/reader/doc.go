...
// comment/regex/string scanning, dispatch/named character classification, symbolic-value lookup, character unicode/octal classification, delimiter/comment/terminating macro classification, delimiter token scanning, delimited form-count/arg-literal/conditional helpers, arg-index gap filling, expected-token consumption, string escape classification, identifier rune checks/validation/explanations, identifier token scanning/validation, initial token classification, number/unicode token classification/scanning, string/unicode escape scanning/parsing, line rune readers,
