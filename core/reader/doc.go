...
// comment/line/regex/string scanning, whitespace-skip decisions, dispatch/named character classification, symbolic-value lookup, character unicode/octal classification, delimiter/comment/terminating macro classification, delimiter token scanning, delimited form-count/arg-literal/conditional/unquote prefix/splice helpers, pending-form popping, arg-index gap filling/ordering, expected-token consumption, string escape classification, identifier rune checks/validation issue enumeration/explanations, identifier token scanning/validation, initial token classification, number/unicode token/escape scanning/parsing, string/unicode escape scanning/parsing, line rune readers,
