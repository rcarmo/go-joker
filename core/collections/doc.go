...
// core's CollectionConstructionAdapter, and the layout guard rejects future
// files in this package that import root core. Concrete implementations should
// move here only after object/protocol dependencies are explicit and acyclic.
package collections
