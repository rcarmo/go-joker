...
core-contract-check:
	$(GO) test ./core -run 'TestCountedIndexedVectorContract|TestAssociativeMapContract|TestSetContract|TestTransientContract|TestInfoAndMetaContract|TestPVObjectSemantics' -count=$(TEST_COUNT) -timeout=120s
