...
core-contract-check:
	$(GO) test ./core -run 'TestCountedIndexedVectorContract|TestAssociativeMapContract|TestSetContract|TestInfoAndMetaContract|TestPVObjectSemantics' -count=$(TEST_COUNT) -timeout=120s
