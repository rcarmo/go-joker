...
std-contract-check:
	$(GO) test ./std/http ./std/io ./std/strconv ./std/time ./std/markdown ./std/os ./std/system ./std/runtime ./std/imaging ./std/pdf ./std/svg ./std/random ./std/bolt ./std/url ./std/git ./std/log -count=$(TEST_COUNT) -timeout=120s
