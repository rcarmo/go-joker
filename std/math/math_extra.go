...
func init() {
	...
	mathNamespace.InternVar("tan", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"))),
			`Returns the tangent of the radian argument x.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("asin", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"))),
			`Returns the arcsine (in radians) of x.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("acos", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"))),
			`Returns the arccosine (in radians) of x.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("atan", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"))),
			`Returns the arctangent (in radians) of x.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("atan2", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("y"), MakeSymbol("x"))),
			`Returns the arc tangent of y/x, using the signs to determine the quadrant.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("sinh", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"))),
			`Returns the hyperbolic sine of x.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("cosh", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"))),
			`Returns the hyperbolic cosine of x.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("tanh", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"))),
			`Returns the hyperbolic tangent of x.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("remainder", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"), MakeSymbol("y"))),
			`Returns the IEEE 754 floating-point remainder of x/y.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("fmod", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"), MakeSymbol("y"))),
			`Returns the floating-point remainder of x/y (same sign as x).`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("max-val", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"), MakeSymbol("y"))),
			`Returns the larger of x or y.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("min-val", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"), MakeSymbol("y"))),
			`Returns the smaller of x or y.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("degrees", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"))),
			`Converts angle x from radians to degrees.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
	...
	mathNamespace.InternVar("radians", Proc{Fn: func(args []Object) Object {
		...
		MakeMeta(NewListFrom(NewVectorFrom(MakeSymbol("x"))),
			`Converts angle x from degrees to radians.`, "1.0").Plus(MakeKeyword("tag"), String{S: "coretypes.Double"}))
}
