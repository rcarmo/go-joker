...
func __hmac_(_args []coretypes.Object) coretypes.Object {
	_c := len(_args)
	switch {
	case _c == 3:
		algorithm := coretypes.ExtractKeyword(_args, 0)
		message := coretypes.ExtractString(_args, 1)
...
func __md5_(_args []coretypes.Object) coretypes.Object {
	_c := len(_args)
	switch {
	case _c == 1:
		data := coretypes.ExtractString(_args, 0)
		t := md5.Sum([]byte(data))
		_res := string(t[:])
		return coretypes.MakeString(_res)
...
func __sha1_(_args []coretypes.Object) coretypes.Object {
	_c := len(_args)
	switch {
	case _c == 1:
		data := coretypes.ExtractString(_args, 0)
...
func __sha224_(_args []coretypes.Object) coretypes.Object {
	_c := len(_args)
	switch {
	case _c == 1:
		data := coretypes.ExtractString(_args, 0)
...
func __sha256_(_args []coretypes.Object) coretypes.Object {
	_c := len(_args)
	switch {
	case _c == 1:
		data := coretypes.ExtractString(_args, 0)
...
func __sha384_(_args []coretypes.Object) coretypes.Object {
	_c := len(_args)
	switch {
	case _c == 1:
		data := coretypes.ExtractString(_args, 0)
...
func __sha512_(_args []coretypes.Object) coretypes.Object {
	_c := len(_args)
	switch {
	case _c == 1:
		data := coretypes.ExtractString(_args, 0)
...
func __sha512_224_(_args []coretypes.Object) coretypes.Object {
	_c := len(_args)
	switch {
	case _c == 1:
		data := coretypes.ExtractString(_args, 0)
...
func __sha512_256_(_args []coretypes.Object) coretypes.Object {
	_c := len(_args)
	switch {
	case _c == 1:
		data := coretypes.ExtractString(_args, 0)
...
var cryptoNamespace = GLOBAL_ENV.EnsureSymbolIsLib(coretypes.MakeSymbol(STRINGS.Intern, "joker.crypto"))
