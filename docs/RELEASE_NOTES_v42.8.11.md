...
- `examples/fractal-flame.joke` demonstrates high-resolution procedural raster generation in Joker code via `joker.jit/compile-wasm` and `joker.imaging/from-rgba32-domain-fn`.
...
go build ./cmd/joker
joker examples/fractal-flame.joke 1024 .cache/flame-mandel.png
```
