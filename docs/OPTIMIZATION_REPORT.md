...
2. **String and sequence throughput**
   ...
   - Typed IR v2 has started behind `JOKER_IR_TYPED=1`, with a tagged primitive/string executor for eligible string loops; early probes reduce allocations in string append and reverse-complement workloads.
