...
them when built into the Joker executable itself. (See `docs/DEVELOPER.md` for more information on `gen_code`.)
...
See [`docs/DEVELOPER.md`](../DEVELOPER.md) for information on Joker internals, such as adding new namespaces to the Joker executable.
...
The use and distribution terms for this software are covered by the
Eclipse Public License 1.0 (http://opensource.org/licenses/eclipse-1.0.php)
which can be found in the file docs/licenses/epl-v10.html in this distribution.
