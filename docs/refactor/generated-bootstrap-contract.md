...
4. Add tests comparing data-only payloads with current root generated behavior. **Started: root-core tests compare generated source-manifest namespaces with current bootstrap behavior; internal generated tests verify manifest source paths exist; `make generated-bootstrap-check` and `make docs-check` guard this equivalence.**
