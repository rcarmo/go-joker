...
- [x] Move reader identifier validation predicates/reasons/issue enumeration/explanations into `core/reader` and remove stale root wrappers.
...
- [x] Move reader conditional/unquote/namespaced-map/delimited-form loop and prefix/splice helpers into `core/reader`.
