...
- [x] Move reader conditional/unquote/namespaced-map/simple-macro/delimited-form loop, read-error mode, suppression, start, prefix, and splice helpers into `core/reader`.
