...
| `core` root | 40 | 1 | still the runtime/evaluator/bootstrap hotspot, but concrete collection files and runtime object wrappers for channels, futures/promises, agents, and atoms have moved out, and atom/chunk/record/protocol/public-form/string/hierarchy/reduced/root-support/IO/goroutine/doc-metadata/tail-call/function-tracing/core-compat/unchecked/tagged-reader glue has been coalesced into domain files |
