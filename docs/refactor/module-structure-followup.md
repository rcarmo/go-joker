...
| `core/reader` | several | several | reader leaf helpers and raw buffered/IO mechanics have started moving here; parser/object implementation remains root-bound |
